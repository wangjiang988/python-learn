...
if username == 'audit' and password == '2016':
    print('login success')
else:
    print('login failed')

host_list = [
    {'host': "172.16.1.1", 'username': 'linux01', 'password': "123456"},
    {'host': "172.16.1.2", 'username': 'linux02', 'password': "123456"},
    {'host': "172.16.1.3", 'username': 'linux03', 'password': "123456"},
]
